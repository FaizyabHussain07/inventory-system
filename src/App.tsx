...
import RetailersPage from './pages/RetailersPage'; // Import the new RetailersPage
    ...
    <Router>
      <SessionContextProvider>
        <Routes>
          ...
          <Route path="/admin/retailers" element={<RetailersPage />} /> {/* New route for RetailersPage */}
